...
<head>
  ...
  <title>EDIT CONTRACT ERROR</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Please contact the system administrator for any changes concerning your contract. Thank you!<br/><br/><b>Phone Number: +25412345678.<br/>Email Address: support@gitanga.com</p>
        </div>
        <!-- /.container-fluid -->
