...
<head>
  ...
  <title>NEW USER REGISRATION</title>
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <p><span style = "color:#4e73df;"><b><b>PERSONAL INFORMATION</b></b></span></p>
              <form class="user" action="<?php echo $_SERVER['PHP_SELF']; ?>" method = "POST">
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                     Not a Kenyan Citizen?&nbsp&nbsp&nbsp
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" name="programme" value="<?php echo @$prog; ?>"placeholder=" Country of Origin" disabled>
                  </div>
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" name="regno" value="<?php echo @$reg; ?>" placeholder="Idenfication Number" disabled>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" name="pno1" value="<?php echo @$pno1; ?>" placeholder="Main PhoneNumber ; 07********" required>
                  </div>
                </div>
                <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                  <input type="text" class="form-control form-control-user" name="pno2" value="<?php echo @$pno2; ?>" placeholder="Alteranative PhoneNumber ; 07********" required>
                </div>
                <div class="col-sm-6">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" name="city" value="<?php echo @$city; ?>" placeholder="City/Town" required>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" name="region" value="<?php echo @$region; ?>" placeholder="County" required>
                  </div>
                  <div class="col-sm-6">
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <option value = "1" id="1">Quaterly</option>
                    <option value = "2" id="2">Monthly</option>
                    <option value = "4" id="4">One-off Payment</option>
                    </select>
                  </div>
                </div>
                <hr>
                <p>Please read the contract <span style = "color:red;">CAREFULLY</span> and check "I agree" if you agree with the TERMS AND CONDITIONS STIPULATED IN THE CONTRACT</p><br/>
                <div class="form-group">
                  <iframe src=" gitangacontract.pdf" width="1000px" height="400px" style="border: none;"></iframe>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                ...
                <hr>
                <p><span style = "color:#4e73df;"><b><b>EMERGENCY CONTACTS INFORMATION</b></b></span></p>
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" name="cpno1" value="<?php echo @$cpno1; ?>" placeholder="Main PhoneNumber; 07********" required>
                  </div>
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" name="cpno2" value="<?php echo @$cpno2; ?>" placeholder="Alternative PhoneNumber; 07********" required>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" name="cpno3" value="<?php echo @$cpno3; ?>" placeholder="Main PhoneNumber; 07********">
                  </div>
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" name="cpno4" value="<?php echo @$cpno4; ?>" placeholder="Alternative PhoneNumber; 07********">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" name="nature1" value="<?php echo @$nature1; ?>" placeholder="Relationship" required>
                  </div>
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" name="nature2" value="<?php echo @$nature2; ?>" placeholder="Relationship" required>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" name="city1" value="<?php echo @$city1; ?>" placeholder="City/Town" required>
                  </div>
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" name="city2" value="<?php echo @$city2; ?>" placeholder="City/Town" required>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" name="region1" value="<?php echo @$region1; ?>" placeholder="County" required>
                  </div>
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" name="region2" value="<?php echo @$region2; ?>" placeholder="County" required>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
