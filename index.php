    ...
    <header class="header mb-5">
      ...
      *** TOPBAR ***
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container"><a href="index.php" class="navbar-brand home"><img src="home.png" alt="GD logo" class="d-none d-md-inline-block"></a>
          <div class="col-lg-6 offer mb-3 mb-lg-0"><a href="index.php" class="ml-1"><b><b><b><b><b><b>GITANGA DUPLEXES</b></b></b></b></b></b></a></div>
            ...
            <div class="product-slider owl-carousel owl-theme">
              <div class="item">
                <div class="product">
                  <div class="flip-container">
                    <div class="flipper">
                    <div class="front"><a><img src="house1_1.jpg" alt="" class="img-fluid"></a></div>
                      <div class="back"><a><img src="house2_1.jpg" alt="" class="img-fluid"></a></div>
                    </div>
                    </div><a class="invisible"><img src="house1_1.jpg" alt="" class="img-fluid"></a>
                  <div class="text">
                    <h3><a>Penthouse</a></h3>
                    <h3><a>Ksh.175,000/=</a></h3>
                    <p class="price">
              ...
              <div class="item">
                <div class="product">
                  ...
                  <div class="text">
                  <h3><a href="login.php">One BedRoom</a></h3>
                    <h3><a href="login.php">Ksh. 50,000/=</a></h3>
                    <p class="price">
                      Available Units:<br/><?php
              ...
              <div class="item">
                <div class="product">
                  ...
                  <div class="text">
                  <h3><a href="login.php">Two BedRoom</a></h3>
              ...
              <div class="item">
                <div class="product">
                  ...
                  <div class="text">
                  <h3><a href="login.php"> Three BedRoom</a></h3>
              ...
              <div class="item">
                <div class="product">
                  ...
                  <div class="text">
                  <h3><a href="login.php">Four BedRoom</a></h3>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-2 mb-lg-0">
            <p class="text-center text-lg-left">20/03043 &copy; Aaron Joseph</p>
          </div>
        </div>
      </div>
    </div>
