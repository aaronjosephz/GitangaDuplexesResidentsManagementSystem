    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <h1 class="h3 mb-2 text-gray-800" align="center">Maintanace Request Form.</h1>
          <p style="color:red;"><b><b>Please fill the required information upon inspecting  the House.</b></b></p>
              ...
              <div class="table-responsive">
                <table class="table table-borderless" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        Condition of the Electricity Meter:
                      </td>
                      <td>
