          ...
          <div class="col-lg-12">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4"><b><b>NEW USER REGISTRATION</b></b></h1>
              </div>
              ...
              <form class="user" action="<?php echo $_SERVER['PHP_SELF']; ?>" method = "POST">
                ...
                <div class="form-group row">
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" name="pno1" value="<?php echo @$pno; ?>" placeholder="Phone Number e.g; 07********" required>
                  </div>
